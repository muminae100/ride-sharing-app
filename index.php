...
<body class="container" style="padding: 0;">
    <div style="position: relative">
        <div class="col-sm-10 card-body">
            <h1 class="title">Ride sharing app</h1>
            <h3 class="small">Sharing Rides</h3>
            <div class="mb-3">
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAvcdAqIMAK-Eb-OoW2TKQMDzZvFHQHK8M&libraries=places,geometry&callback=initMap"></script>
</body>
</html>